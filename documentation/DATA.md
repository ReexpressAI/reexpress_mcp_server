...
For reference, if you want to pull up the row in OpenVerification1 (or similarly for other datasets) for a particular document (e.g., when using the interactive graphs), the following can be used:
