#########################################################################################################
##################### These are the parameters we used to train the v2.3.0.preview release.
...
conda activate re_mcp_v230 # conda environment with applicable dependencies

RUN_SUFFIX_ID="sdm_verification__v2_3_0_e700iter10_lr0.000001_updated_data_api_agreement_emb"
MODEL_TYPE="release1a"


DATA_DIR="/home/jupyter/data/openverification1_2026_04_09" # Update with the applicable path; this is from the OpenVerification1 dataset on HuggingFace)
...
MODEL_OUTPUT_DIR="/home/jupyter/models/preview/sdm_verification__v2_3_0_e700iter10_lr0.000001_updated_data_api_agreement_emb_release1a_0.9_1000"
...
LATEX_MODEL_NAME='modelReexpressMCPServerVersion230'
...
for EVAL_LABEL in "openthoughts_eval" "best_iteration_data_calibration"; do
...
if [ "$EVAL_LABEL" = "best_iteration_data_calibration" ]; then
    ...
    EVAL_FILE="/home/jupyter/data/openverification1_2026_04_09_additions__reexpress_formatted/only_agreement_embedding/openthoughts_eval.jsonl"
fi
...
--additional_latex_meta_data="${EVAL_LABEL},${LATEX_MODEL_NAME}"> ${MODEL_OUTPUT_DIR_WITH_SUBFOLDER}/"eval.${EVAL_LABEL}.version_2.3.0.log.txt"
...
MODEL_OUTPUT_DIR=/home/jupyter/models/preview/sdm_verification__v2_3_0_e700iter10_lr0.000001_updated_data_api_agreement_emb_release1a_0.9_1000/ # Update with the applicable path from the github release download
...
INPUT_FILE=${INPUT_DIR}/eval.openthoughts_eval.all_predictions.jsonl
FILE_LABEL="OpenVerification1 5k Test (Gemini-3.1, GPT-5.4)"
OUTPUT_FILE_PREFIX="OpenVerification1-Gemini31GPT54-5k-Test"
X_AXIS_HISTOGRAM_WIDTH=200
